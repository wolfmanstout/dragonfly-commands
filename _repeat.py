...
command_action_map = utils.combine_maps(
    utils.text_map_to_action_map(symbols_map),
    {
        ...
        "scroll up": Function(lambda: eye_tracker.move_to_position((0, 50))) + Mouse("wheelup:10"),
        "scroll up half": Function(lambda: eye_tracker.move_to_position((0, 50))) + Mouse("wheelup:5"),
        "scroll down": Function(lambda: eye_tracker.move_to_position((0, -50))) + Mouse("wheeldown:10"),
        "scroll down half": Function(lambda: eye_tracker.move_to_position((0, -50))) + Mouse("wheeldown:5"),
