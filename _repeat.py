...
docs_action_map = {
    ...
    "(previous|preev) comment": Key("ca-p, ca-c"),
    "next comment": Key("ca-n, ca-c"),
    "enter comment": Key("ca-e, ca-c"),
    "(new|insert) row above": Key("a-i/15, r"),
    "(new|insert) row": Key("a-i/15, b"),
    "duplicate row": Key("s-space, c-c, a-i/30, b, c-v/30, up/30, down"),
