...
shell_action_map = utils.combine_maps(
    shell_command_map,
    {
        ...
        "[<n>] pret": Key("cs-left/5:%(n)d"),
        "[<n>] net": Key("cs-right/5:%(n)d"),
        "[<n>] move tab left": Key("cs-pgup/5:%(n)d"),
        "[<n>] move tab right": Key("cs-pgdown/5:%(n)d"),
...
chrome_action_map = {
    ...
    "address bar":        Key("c-l"),
    "[<n>] back":               Key("a-left/15:%(n)d"),
    "[<n>] Frak":            Key("a-right/15:%(n)d"),
    "reload": Key("c-r"),
    "shot <tab_n>": Key("c-%(tab_n)d"),
    "shot last": Key("c-9"),
    "[<n>] net":           Key("c-tab:%(n)d"),
    "[<n>] pret":           Key("cs-tab:%(n)d"),
    "[<n>] move tab left": Key("cs-pgup/5:%(n)d"),
    "[<n>] move tab right": Key("cs-pgdown/5:%(n)d"),
